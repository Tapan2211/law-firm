...
export default function WhyUs() {
    let cardData=[
        { title:"98% Success Rate",text:"Amet minim mollit non deserunt ullamco estsit aliqua dolor do amet sint. Velit officia consequatduis enim velit mollit Exer."},
        { title:"100% Success Rate",text:"Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequatduis enim velit mollit Exer.",color:'var(--gray-bg)'},
  ...
  return (
    <div className={styles.whyusWrapper}  id="about-us">
        ...
        <div className={styles["card-wrapper"]}>
          {/* <Card title="98% Success Rate" text="Amet minim mollit non deserunt ullamco est
