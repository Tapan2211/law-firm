...
export default function Card({title,text,color,designation,src}) {
  return (
    ...
    //     </div>
    // </div>
    <div className={styles.card} style={{backgroundColor:color?color:undefined}}>
        <div className={styles.imgContainer}>
       { src?<img src={src} width={101}  />:<img src={require("../../assets/card-img.png")} width={101} height={101} />}
