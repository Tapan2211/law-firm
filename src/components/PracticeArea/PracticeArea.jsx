...
let imgData=[
    {img1:{src:businesslaw1,text:"BUSINESS LAW"},img2:{src:partnershiplaw,text:"PARTNERSHIP LAW"}},
    {img1:{src:realestatelaw,text:"REAL ESTATE LAW"},img2:{src:businesslaw2,text:"BUSINESS LAW"}},
    {img1:{src:landloard,text:"LANDLORD DISPUTES"},img2:{src:elderAbuse,text:"ELDER ABUSE"}
}]
...
export default function PracticeArea() {
    ...
    return (<><div className={styles['even-1']} key={`pa{index}`}><img src={ele.img1.src} /><h3 className={styles['img-caption']}>{ele.img1.text}</h3></div> 
                ...
                return (<><div   className={styles['odd-1']} key={`pa{index}`}> <img src={ele.img1.src} />
